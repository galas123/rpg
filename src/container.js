...
import HeroDeath from './components/heroDeath';
import {setRandomItems} from './AC/setRandomItems';
import {
    isLooserSelector, isWinnerSelector, attackSelector, dungeonNumberSelector, heartSelector, levelSelector,
    nextLevelLabelSelector, weaponSelector
...
const mapStateToProps = state => {
    ...
    return {
        ...
        nextLevel: nextLevelLabelSelector(dungeon),
